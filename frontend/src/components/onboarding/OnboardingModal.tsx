...
export default function OnboardingModal({ isOpen, onClose, onComplete }: OnboardingModalProps) {
  ...
  const slides = [
    ...
    },
    {
      ...
      type: "options",
      field: "gender",
      options: [t('male'), t('female'), t('other'), t('preferNotToSay')],
    },
    {
      id: "existingConditions",
      question: t('qConditions'),
      subtext: t('subConditions'),
      type: "textarea",
    ...
    },
    {
      ...
      type: "textarea",
      field: "medications",
      placeholder: t('phMeds'),
    },
    {
      id: "previousConditions",
      question: t('qHistory'),
      subtext: t('subHistory'),
      type: "textarea",
      field: "previousConditions",
      placeholder: t('phHistory'),
    },
    {
      id: "address",
      question: t('qAddress'),
      subtext: t('subAddress'),
      type: "address_group",
      field: "address",
    },
  ];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {(slide.options || []).map((opt) => (
              <button
                ...
                className={`p-6 rounded-xl border-2 text-left transition-all ${formData.gender === opt
      ...
      >
        ...
        <div className="p-6 flex justify-between items-center text-stone-400">
          <div className="text-sm font-medium tracking-widest uppercase">
            {t('stepOf', { current: currentStep + 1, total: slides.length })}
          </div>
        </div>
        ...
        <div className="p-8 border-t border-stone-100 flex justify-between items-center bg-white">
          ...
          >
            {isSubmitting ? t('finishing') : currentStep === slides.length - 1 ? t('complete') : t('next')}
